...
Link to the [example](https://smart-data-models.github.io/dataModel.UrbanMobility/GtfsAccessPoint/examples/example-geojsonfeature.json) (geojson feature) for NGSI-LD
