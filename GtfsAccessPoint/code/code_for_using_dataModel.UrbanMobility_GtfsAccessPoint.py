...
dataModel = "GtfsAccessPoint"
subject = "dataModel.UrbanMobility"
hasParentStation = "{'type': 'Relationship', 'object': 'urn:ngsi-ld:GtfsStation:Madrid:est_90_21'}"
attribute = "hasParentStation"
value = hasParentStation
