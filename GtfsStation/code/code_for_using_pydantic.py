...
class GtfsStation(BaseModel):
    ...
    code: Optional[str] = Field(None, description='Same as GTFS `stop_code`')
    ...
    ] = Field(None, description='Same as GTFS `parent_station`')
    hasService: Optional[
        Union[
            constr(
                pattern=r'^[\\w\\-\\.\\{\\}\\$\\+\\*\\[\\]`|~^@!, :\\\\]+$',
    ...
    stop_desc: Optional[str] = Field(None, description='Same as GTFS `stop_desc`')
    type: Optional[Type6] = Field(
        None, description='NGSI Entity type. It has to be GtfsStation'
    )
