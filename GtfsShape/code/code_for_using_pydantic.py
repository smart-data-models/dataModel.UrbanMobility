...
class DistanceTravelledItem(RootModel[confloat(ge=0.0)]):
...
class GtfsShape(BaseModel):
    ...
    distanceTravelled: Optional[List[DistanceTravelledItem]] = Field(
        None,
    ...
    type: Optional[Type6] = Field(
        None, description='NGSI Entity type. It has to be GtfsShape'
    )
